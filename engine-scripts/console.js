...
if (!consoleElement) {
  document.body.insertAdjacentHTML(
    "beforeend",
    '<div id="console" style="border: 1px solid black; padding: 10px; margin: 10px; font-family: monospace; white-space: pre-wrap;"></div>',
  );
}
